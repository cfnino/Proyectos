...
public class UserBean {
	...
	public String actualizarDatos()
	{
		...
		if(user.getUserType().equals("ADMIN"))
		{
			...
			else
			{
				...
				FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "","Actualización de datos exitosa.");
				PrimeFaces.current().dialog().showMessageDynamic(message);
	...
	public void actualizarContrasena()
	{
		...
		if(contrasenaAnterior.equals("") && contrasenaNueva.equals("") && contrasenaNuevaRep.equals(""))
		{
			FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Campos requeridos","Llene todos los campos por favor.");
			PrimeFaces.current().dialog().showMessageDynamic(message);
		}
